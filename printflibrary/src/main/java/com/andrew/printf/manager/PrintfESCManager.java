...
import com.andrew.printf.interfaceCall.MultiplePrintfResultCallBack;
import com.andrew.printf.model.ESCPrinterModel;
import com.andrew.printf.model.PrinterInfo;
import com.andrew.printf.utils.BarcodeUtil;
import com.andrew.printf.utils.ImageUtil;
import com.andrew.printf.utils.ParameterUtil;
import com.andrew.printf.utils.SharedPreferencesUtil;
...
public class PrintfESCManager {
    ...
    public static PrintfESCManager getInstance(final Context context) {
        if (PrintfReceiptManagerHolder.instance.context == null) {
            PrintfReceiptManagerHolder.instance.context
                    = context.getApplicationContext();
            PrintfReceiptManagerHolder.instance.bluetoothManager
    ...
    public void getLastPrintfResult(final PrintfResultCallBack printfResultCallBack) {
        ...
        printfInfoManager.getPrinterCmdTypeAsync(new PrintfInfoManager.GetPrinterCmdCallBack() {
            ...
            public void getSuccess() {
                if(printfResultCallBack != null) {
                    PrinterInfo printerInfo = printfInfoManager.getPrinterInfo();
